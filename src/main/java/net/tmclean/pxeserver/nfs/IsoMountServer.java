...
public class IsoMountServer extends mount_protServerStub {

    private static final Logger _log = LoggerFactory.getLogger(IsoMountServer.class);
    ...
    public IsoMountServer(ExportFile exportFile, VirtualFileSystem fs) {
        super();
