...
public class ImageMountServer extends mount_protServerStub {

    private static final Logger _log = LoggerFactory.getLogger(ImageMountServer.class);
    ...
    public ImageMountServer( ExportFile exportFile, VirtualFileSystem fs ) {
        super();
